...
/*
	creating a satabase for a online cinema booking system
    consistng of 7 tables
...
insert into bookings(screening_id,customer_id) value(212,120);
select * from bookings; -- error foreign key
